...
const PHOTOS = [
  { src: 'https://tapesingkongmumtazkafe.wordpress.com/wp-content/uploads/2026/02/icon-tape-singkong.jpg',    alt: 'Tape Singkong Mumtaz — tampak atas' },
  { src: 'https://tapesingkongmumtazkafe.wordpress.com/wp-content/uploads/2026/02/img20251207170428.jpg',    alt: 'Tape Singkong segar baru jadi' },
  { src: 'https://tapesingkongmumtazkafe.wordpress.com/wp-content/uploads/2026/02/img20251207215953.jpg',    alt: 'Tape Singkong siap disajikan' },
  { src: 'https://tapesingkongmumtazkafe.wordpress.com/wp-content/uploads/2026/02/img20251207165744.jpg',    alt: 'Tekstur kenyel tape singkong' },
];
...
const TESTIMONIALS = [
  {
    ...
    text:   'Tape singkongnya enak banget! Kenyel kayak mochi, manisnya pas. Keluarga saya langsung ketagihan.',
    rating: 5,
  },
  {
    name:   'Pak Dani',
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-36 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-10 animate-fade-up-delay-2">
              Tape singkong premium buatan tangan, difermentasi alami tanpa pengawet.
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-xl mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">
              {product?.name ?? 'Tape Singkong Mumtaz'}
            </h2>
            <p className="text-slate-500 leading-relaxed">
              {product?.description ?? 'Tape singkong premium buatan tangan dengan fermentasi alami. Harum, manis, dan kenyel sempurna.'}
            </p>
          </div>
      ...
      <section id="cara-pesan" className="py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-lg mx-auto mb-14">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">Hanya 3 langkah untuk menikmati tape singkong segar kami.</p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 left-4 right-4 bg-white rounded-xl p-4 shadow-xl border border-slate-100">
              ...
              <p className="text-xs text-slate-400 mt-1">— Mumtaz Kafe</p>
            </div>
          </div>
          ...
          <div className="pt-10 lg:pt-0">
            ...
            <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
              <p>
                Mumtaz Kafe lahir dari kecintaan mendalam pada cita rasa tradisional Indonesia.
                Tape singkong bukan sekadar camilan — ia adalah warisan budaya, hasil kerja keras,
              ...
              <p>
                Kami berkomitmen untuk terus menghadirkan tape singkong yang harum, manis, dan kenyel
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 py-20 sm:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-4">
            Daftar sebagai member Mumtaz Kafe dan dapatkan poin reward di setiap pembelian.
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">Tape Singkong — Harum, Manis, Alami 🤲</p>
          </div>
          ...
          <p className="text-xs text-slate-600">© {new Date().getFullYear()} Mumtaz Kafe</p>
        </div>
      </footer>
