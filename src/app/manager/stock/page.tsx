    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Pantau dan kelola inventarisasi</p>
        </div>
      </div>
                ...
                {stockItems.map((item) => {
                  ...
                  return (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        <StockAdjustmentDialog variantId={item.id} variantName={`${item.product.name} - ${item.name}`} currentStock={item.stock} />
                      </TableCell>
                    </TableRow>
                  );
                })}
